...
public class RegonValidatorData extends BaseStepData implements StepDataInterface {
	...
	public int indexOfResultRegionField = -1;
	public int indexOfResultStdRegonField = -1;

	public int numResultFields;

	public RegonValidatorData() {
		super();
