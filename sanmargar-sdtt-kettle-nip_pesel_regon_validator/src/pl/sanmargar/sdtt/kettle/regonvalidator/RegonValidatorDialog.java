...
public class RegonValidatorDialog extends BaseStepDialog implements StepDialogInterface {

	private static Class<?> PKG = RegonValidatorMeta.class;

	private RegonValidatorMeta meta;

	private RegonValidatorDialogContent wDialogContent;

	public RegonValidatorDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "RegonValidatorStep.Shell.Title"));
		...
		wDialogContent = new RegonValidatorDialogContent(shell, SWT.NONE, meta, transMeta, stepname);
