...
public class NIPValidatorData extends BaseStepData implements StepDataInterface {
//	public int indexOfField = -1;
	  ...
	  public int indexOfResultTaxOfficeNameField  = -1;
	  public int indexOfResultStdNipField  = -1;
