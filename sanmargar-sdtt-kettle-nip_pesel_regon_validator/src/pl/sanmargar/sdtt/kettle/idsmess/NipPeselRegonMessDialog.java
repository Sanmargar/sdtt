...
public class NipPeselRegonMessDialog extends BaseStepDialog implements StepDialogInterface {

	private static Class<?> PKG = NipPeselRegonMessMeta.class;

	private NipPeselRegonMessMeta meta;

	private NipPeselRegonMessDialogContent wDialogContent;

	public NipPeselRegonMessDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "PeselValidatorStep.Shell.Title"));
		...
		wDialogContent = new NipPeselRegonMessDialogContent(shell, SWT.NONE, meta, transMeta, stepname);
