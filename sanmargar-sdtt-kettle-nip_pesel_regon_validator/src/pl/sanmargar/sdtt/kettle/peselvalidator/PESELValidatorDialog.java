...
public class PESELValidatorDialog extends BaseStepDialog implements StepDialogInterface {

	private static Class<?> PKG = PESELValidatorMeta.class;

	private PESELValidatorMeta meta;

	private PESELValidatorDialogContent wDialogContent;

	public PESELValidatorDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
	...
	public String open() {
		...
		wDialogContent = new PESELValidatorDialogContent(shell, SWT.NONE, meta, transMeta, stepname);
